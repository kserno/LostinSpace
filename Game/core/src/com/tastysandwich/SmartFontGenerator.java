...
import com.tastysandwich.writer.BitmapFontWriter;
...
public class SmartFontGenerator {
	...
	public BitmapFont createFont(FileHandle fontFile, String fontName, int fontSize) {
		...
		Preferences fontPrefs = Gdx.app.getPreferences("com.tastysandwich.smartfont");
	...
	/** @see com.tastysandwich.SmartFontGenerator#setGeneratedFontDir(String) */
	...
	/** @see com.tastysandwich.SmartFontGenerator#setReferenceScreenWidth(int) */
	...
	/** @see com.tastysandwich.SmartFontGenerator#setPageSize(int) */
